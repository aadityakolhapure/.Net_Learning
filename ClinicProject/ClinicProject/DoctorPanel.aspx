<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorPanel.aspx.cs" Inherits="ClinicProject.DoctorPanel" %>
...
<body>
    <%
        ...
        if (Session["userId"] == null || Session["email"] == null || Session["roleId"] == null || Convert.ToInt32(Session["roleId"]) == 2)
        {
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="DoctorPanel.aspx" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <a href="#patient" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div id="alert-border-3" class="flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800 fixed bottom-0 right-0 z-25 m-4" role="alert">
            ...
            <div class="ms-3 text-sm font-medium">
                Welcome to Doctor Dashboard Panel!
            </div>
            ...
            <div class="flex items-center p-8 mb-8 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-700 shadow-xl rounded-2xl space-x-8">
                ...
                <div>
                    ...
                    <p class="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-200">
                        Specialization: <span class="text-blue-700 dark:text-blue-400"><%Response.Write(Session["specilization"]); %></span>
                    </p>
                </div>
            </div>
